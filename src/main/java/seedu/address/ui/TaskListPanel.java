...
public class TaskListPanel extends UiPart<Region> {
    ...
    public TaskListPanel(ObservableList<Task> taskList) {
        ...
        taskInformationView.setVisible(true);
        this.destroyTaskInformationView();
    }
...
//        this.gridPane.getColumnConstraints().get(1).setPercentWidth(0.0);
        taskInformationView.getChildren().clear();
        taskInformationView.setAlignment(Pos.CENTER);
        taskInformationView.getChildren().add(new Label("Select a Task..."));
    }
